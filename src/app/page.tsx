...
export default function HomePage() {
  return (
    <main className="flex min-h-screen flex-col item-center justify-center gap-6 bg-slate-50 p-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        ...
        <Link
          href="/staff"
          className="rounded-md border border-slate-300 bg-white px-6 py-3 text-center text-sm font-semibold text-white hover:bg-sky-700"
        >
